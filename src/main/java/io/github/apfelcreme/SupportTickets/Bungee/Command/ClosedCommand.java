        ...
        if (player.hasPermission("SupportTickets.mod")) {
            if (args.length > 1) {
                ...
                if (target != null) {
                    ...
                    SupportTickets.sendMessage(player, SupportTicketsConfig.getInstance().getText("info.closed.header")
                            .replace("{0}", args[1])
                    ...
                    SupportTickets.sendMessage(player, SupportTicketsConfig.getInstance().getText("info.closed.footer"));
