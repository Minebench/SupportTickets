...
public class MySQLConnector {
    ...
    public void initConnection() {
        if (SupportTicketsConfig.getInstance().getSqlDatabase() != null && !SupportTicketsConfig.getInstance().getSqlDatabase().isEmpty()) {
            ...
            hikariConfig.setJdbcUrl("jdbc:mysql://" + SupportTicketsConfig.getInstance().getSqlUrl()
                    + "/" + SupportTicketsConfig.getInstance().getSqlDatabase());
        ...
        try {
            if (connection != null) {
                ...
                statement = connection.prepareStatement(
                        "CREATE TABLE IF NOT EXISTS " + SupportTicketsConfig.getInstance().getPlayerTable() +
                                "(" +
                ...
                statement = connection.prepareStatement(
                        "CREATE TABLE IF NOT EXISTS " + SupportTicketsConfig.getInstance().getTicketTable() +
                                "(" +
                                ...
                                "FOREIGN KEY (player_id) references " + SupportTicketsConfig.getInstance().getPlayerTable() + "(player_id), " +
                                "FOREIGN KEY (closed_player_id) references " + SupportTicketsConfig.getInstance().getPlayerTable() + "(player_id) " +
                                ")");
                statement.executeUpdate();

                statement = connection.prepareStatement(
                        "CREATE TABLE IF NOT EXISTS " + SupportTicketsConfig.getInstance().getCommentTable() +
                                "(" +
                                ...
                                "FOREIGN KEY (ticket_id) references " + SupportTicketsConfig.getInstance().getTicketTable() + " (ticket_id), " +
                                "FOREIGN KEY (player_id) references " + SupportTicketsConfig.getInstance().getPlayerTable() + " (player_id), " +
