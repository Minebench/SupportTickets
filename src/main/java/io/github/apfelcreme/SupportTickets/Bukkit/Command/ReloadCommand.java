...
public class ReloadCommand implements SubCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        if (sender.hasPermission("SupportTickets.reload")) {
            try {
                SupportTickets.getInstance().reloadConfig();
                SupportTicketsConfig.load();
                SupportTickets.sendMessage(sender, SupportTicketsConfig.getText("info.reload.reloaded"));
            } catch (IOException e) {
                e.printStackTrace();
